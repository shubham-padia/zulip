...
export class MessageListView {
    ...
    update_sticky_recipient_headers(): void {
        ...
        const sticky_header_top = message_viewport.sticky_header_top();
        ...
        const partially_hidden_header_position = sticky_header_top - 1;
        ...
        function is_sticky(header: Element): number {
            ...
            const sticky_or_about_to_be_sticky_header_position =
                sticky_header_top + header_props.height + margin_between_recipient_rows;
