...
class InviteUserTest(InviteUserBase):
    ...
    def test_successful_invite_users_with_specified_streams(self) -> None:
        ...
        self.assertCountEqual(get_slim_realm_default_streams(realm.id), [denmark, sandbox, zulip])
        self.assert_json_success(
            self.invite(
        ...
        self.assertCountEqual(get_slim_realm_default_streams(realm.id), [denmark, zulip])
        self.submit_reg_form_for_user(invitee, "password")
