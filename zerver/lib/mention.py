...
from zerver.lib.streams import filter_stream_authorization_for_content_access
...
class MentionBackend:
    ...
    def get_stream_name_map(
        ...
        if acting_user is None:
            ...
            authorization = filter_stream_authorization_for_content_access(
                acting_user,
                list(
                    Stream.objects.filter(
                        realm_id=self.realm_id,
            ...
            for stream in authorization.content_access_streams:
